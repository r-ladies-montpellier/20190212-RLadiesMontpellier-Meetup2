...
--
 ...
 - Tip: Don't forget to use `==` for a condition  
...
--
 ...
 - Tip1: `pop / 100000` , `lifeExp * 12`

--

 - Tip2: you can create as many columns as you want in the same `mutate()`
...
--
 ...
 - Tip: for more than to cases, use `case_when()`
...
--
 ...
 - Tip: You can use `starts_with("c")` (but it's not the only solution)
...
In that case we can take a look at the webpage [**R Graph Gallery**](https://www.r-graph-gallery.com/), or at [**ggplot2 extensions**](https://www.ggplot2-exts.org/gallery/), or, if, like me, you love interactive plots
